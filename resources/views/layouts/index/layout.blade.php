...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ URL::asset('assets/images/logo.webp') }}">
    ...
    <style>
        ...
        .product-single-thumb img {
            ...
            object-fit: cover;
            /* Scale the image to preserve its aspect ratio while fitting within the element's content box */
        }
    </style>
    <style>
        .product-details-content.bottom-price {
            display: flex;
                ...
                <div class="row align-items-center">
                    <div class="col-3 col-sm-3 col-lg-3">
                        <div class="header-logo">
                            <a href="{{ route('main') }}">
                                <img class="logo-main" src="{{ URL::asset('assets/images/logo.webp') }}" width="95"
                                    height="68" alt="Logo" />
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="widget-item">
                                <div class="widget-about">
                                    <a class="widget-logo" href="{{ route('main') }}">
                                        <img src="{{ URL::asset('assets/images/logo.webp') }}" width="200"
                                            height="200" alt="Logo">
                                    </a>
                        ...
                        <div class="col-md-6 col-lg-3 mt-lg-0 mt-6">
                            <div class="widget-item">
                                ...
                                <div class="widget-social">
                                    <a href="https://www.instagram.com/fhapharma?fbclid=IwZXh0bgNhZW0CMTAAAR0p_vGdUvxWFxi6JXnxlpueZH6wf2a9ajbdCVjP3s643XcvIZbzw5clU5Y_aem_AfOSZ65HpJUucSJxXwMvSo-QiymuvkLSIbdSm95KVWieV9IT-X-YQZ6RTQfglz1G8XVSag8Z2pLbfPI8nxjNbaWG"
                                        target="_blank" rel="noopener">
                                        <i class="fab fa-instagram"></i>
                                    </a>
                                    <a href="https://www.facebook.com/profile.php?id=61552599025055" target="_blank"
                                        rel="noopener">
                                        <i class="fab fa-facebook-f"></i>
                                        <!-- Note: 'fa-facebook-f' might be the correct class for Facebook depending on the specific icon style you want -->
                                    </a>
            ...
            <div class="footer-bottom">
                <div class="container pt-0 pb-0">
                    <div class="footer-bottom-content">
                        <p class="copyright">© 2024 FHA PHARMA. powered by <a target="_blank"
                                href="https://www.hdragency.com/">HDR.</a></p>
                    </div>
                </div>
            </div>
            <!--== End Footer Bottom ==-->
